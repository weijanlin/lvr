...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('improved_import.log', encoding='utf-8'),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger(__name__)

class ImprovedDataImporter:
    """改進的資料匯入器"""
...
def test_improved_importer():
    ...
    for file_type, files in stats.items():
        print(f"\n🔸 {file_type}:")
        total_rows = 0
    ...
    # 測試單一檔案匯入
    print(f"\n🔄 測試單一檔案匯入...")
    test_file = "113Q1/a_lvr_land_b.csv"  # 預售屋檔案
